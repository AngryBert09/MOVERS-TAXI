                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="alert alert-info">
                            <strong>Evaluate Training Facility</strong>
                        </div>
                        ...
                        <form action="{{ route('facility-evaluation.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                <label for="question1">1. Cleanliness of training rooms</label>
                            ...
                            <div class="form-group">
                                <label for="question2">2. Comfort of seating and room temperature</label>
                            ...
                            <div class="form-group">
                                <label for="question3">3. Quality of training materials</label>
                            ...
                            <div class="form-group">
                                <label for="question4">4. Access to necessary equipment</label>
                            ...
                            <div class="form-group">
                                <label for="question5">5. Availability of internet or digital resources</label>
                            ...
                            <div class="form-group">
                                <label for="question6">6. Functionality of projectors/screens</label>
                            ...
                            <div class="form-group">
                                <label for="question7">7. Safety features and exits clearly marked</label>
                            ...
                            <div class="form-group">
                                <label for="question8">8. Accessibility for people with disabilities</label>
                            ...
                            <div class="form-group">
                                <label for="question9">9. Availability of rest areas or lounges</label>
                            ...
                            <div class="form-group">
                                <label for="question10">10. General ambiance and learning environment</label>
