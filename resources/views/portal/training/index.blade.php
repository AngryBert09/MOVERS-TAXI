            ...
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title">Current Training</h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                                <li class="breadcrumb-item active">Current Training</li>
                            </ul>
                        </div>
                                ...
                                <tbody id="applicantTableBody">
                                    @foreach ($trainings as $training)
                                        <tr>
                                            ...
                                            <td>
                                                @php
                                                    // Find the trainee's full name based on the trainee_id
$trainee = $employees->firstWhere('id', $training->trainee_id);
                                                @endphp
                                            ...
                                            <td class="text-right">
                                                <div class="dropdown dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        {{-- <a class="dropdown-item" href="#" data-toggle="modal" data-target="#deleteBudgetModal">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-6">
                                                                        <form id="deleteBudgetForm"
                                                                            ...
                                                                            @method('DELETE')
                                                                            <button type="submit"
                                                                                class="btn btn-danger btn-lg btn-block continue-btn">Delete</button>
                                                                        </form>
                                                                    </div>
                                                                    <div class="col-6">
